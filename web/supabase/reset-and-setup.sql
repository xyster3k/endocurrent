...
DROP TABLE IF EXISTS public.article_reports CASCADE;
DROP TABLE IF EXISTS public.article_likes CASCADE;
DROP TABLE IF EXISTS public.article_references CASCADE;
...
-- SUCCESS!
-- ============================================
-- Database reset complete. All tables created with correct schema.
-- Next: Run setup-admin-user.sql to create your admin user
